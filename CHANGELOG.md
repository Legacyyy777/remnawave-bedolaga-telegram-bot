...
## [3.43.0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/compare/v3.42.0...v3.43.0) (2026-03-26)


### New Features

* add _calculate_servers_price (fixed fallback) and _calculate_traffic_price ([88369ee](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/88369eec5047e733d26d2450a74abd0d600b2e1b))
* add admin topic notifications for landing page purchases ([dbb9757](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/dbb9757a3c7938ab7505358942f675b82401245a))
* add cabinet gift subscription API routes and schemas ([6a61b09](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6a61b095755885ff8973eb9ac4422740d07e0306))
* add cabinet menu layout editor with row arrangement, custom URL buttons, and drag-and-drop reordering ([dd8d7f6](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/dd8d7f69203490553d15dcdad6dda28fab02d593))
* add CABINET_GIFT_ENABLED branding toggle ([759bfe1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/759bfe1bdb3a3d3f917334fd32d0ea2f5be5d1f0))
* add CLASSIC_PERIOD_PRICES to config ([c3bb63f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c3bb63ffed6e0b684c322aa51d70ab7e71c8eb6b))
* add configurable animated background for landing pages ([11d3e63](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/11d3e637c106590a73ed804fc762bf303b37dd62))
* add discount system for landing pages ([aa7d986](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/aa7d98630dd9be2cfb81dac3ef2c1c6730487e61))
* add external squad support for tariffs ([c10d678](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c10d6780ba89ac641769dcb0c4ab2d89f124f0b7))
* add GET /admin/rbac/users endpoint for listing all RBAC users ([8b77cda](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8b77cdae2ccc489bfead89523f31cd15bfdc675b))
* add gifts section to admin user detail API ([bca8bab](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/bca8bab4336b2583da9be8c642985e6a0151e33d))
* add landing page statistics endpoint with charts data ([25478ce](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/25478ced209fdbf12f2c398ad1c8d48ac26c923e))
* add landings to permission registry ([c93dbec](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c93dbec7a0e24a6cc41449ed3c6e5fb669b127a9))
* add LIMITED subscription status and preserve extra devices on tariff switch ([8f43452](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8f434525eb14618e3c3e26261d443b1632c111bb))
* add managed news categories and tags with DB-backed CRUD ([51392d1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/51392d1918d8e2e94645acfb3a11b8e16776a5d5))
* add media attachment support for admin ticket replies ([69bb399](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/69bb399b63d6e1d761cc5518e6272917fc5a6ae7))
* add media upload/delete API for news articles ([a0d40ad](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/a0d40ad432d858ebfe75485a9597d32e847d5746))
* add multi-provider recovery, retry_count, amount verification, and indexes ([3d78974](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3d78974af70b360449d9cf634e09a79821cdc7c0))
* add NaloGO fiscal receipts for code-only gift purchases ([90209eb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/90209ebef1a872665e622124a1898d52eff398e7))
* add news articles module with admin CRUD and public API ([b932403](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b93240393f739f1243bbbfdd4298b90974b8fa87))
* add open_in setting for custom buttons (external browser / webapp) ([497a8ee](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/497a8ee5b528cf80d7042a7eec62369b6a327339))
* add paginated purchases list endpoint for landing pages ([0ba1127](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0ba112746913bb9927338a7554370ac8c4e12039))
* add partner → campaign edges to referral network graph ([01132a7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/01132a7bc77b07eaaaf876c05d639bfed83e5324))
* add promo group and promo offer discounts to gift subscriptions ([2fd0f6a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2fd0f6aa4eb62f704208c1e56a6542d3967e7867))
* add referral network graph visualization admin API ([c08c903](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c08c903e8f94f3730872b19de904ce166ba35b98))
* add RenewalPricing dataclass and PricingEngine discount methods ([83ca51c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/83ca51cd5b040e747c6db904dde0f3a5c59f480f))
* add SBP and Card sub-options for KassaAI payment method ([5b722c5](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5b722c521036befcbbaf6192215f651c2ec9c4fb))
* add SBP and Card sub-options to kassa_ai payment method ([04419fd](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/04419fdff7dc244eb2c9553ea1501e2de454010b))
* add scoped referral network graph with scope selector API ([df086b0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/df086b09c75a9157cdc558fb610b617a2d49deaf))
* add show_in_gift toggle for tariffs in admin panel ([cb5126a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cb5126aff8c15938a59ea9c4f8e605b250b05dbc))
* add SOCKS proxy support for nalogo (tax service) module ([3c5bf4f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3c5bf4fa22d1cdf144269f4e6ab32a4523c8f1f3))
* add SOCKS5 proxy support for Telegram API traffic ([82b6a8b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/82b6a8bf707736541b58637b0fc9a84b0c403a6c))
* add source and buyer_user_id fields to GuestPurchase model ([0936d4a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0936d4a7f651a1fcef8c2f86818320af3764b423))
* add subscription status to referral network graph nodes ([de91d32](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/de91d3282ffa15c0cec60c0d62871d39e7ee4c05))
* add sync-squads endpoint for bulk updating subscription squads in Remnawave ([b1e2146](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b1e2146254255586b5be9bd894ac4d113a0a8cf5))
* add telegram gift notification with inline activation button ([9ba61a0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/9ba61a08796fbc06e0dea2ee9cb02edc4126b335))
* add total subscription revenue to referral network stats ([2bdb764](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2bdb7643f8fd142e99caee0fe989348161377348))
* add user_email to admin payments API response ([7101555](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7101555da0722d1eacd97f40b6b8c8c3a2327a0c))
* allow inactive tariffs for trial subscription activation ([cce3b0c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cce3b0c13bcbf0b567bd4dcf2670973382e7cab0))
* auto-resume disabled daily subscriptions on balance topup ([770b31d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/770b31d3d05c22411b64ddbea3c304e34d879f5b))
* auto-sync squads to Remnawave when admin updates tariff ([076290e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/076290e0c1d81b610a7653d6b64ed218e0f124b4))
* broadcast caption validation + landing daily created stats ([d400cd7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d400cd7b49cb18edf8545a5af54009561610218a))
* custom broadcast buttons and fix home button to use bot menu ([13ea376](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/13ea3768b516337c4e0320120bc60a9acb27a16b))
* deep link авторизация в кабинете при блокировке oauth.telegram.org ([322d457](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/322d45765220c854e36ae0b4b862a96d36ae3be8))
* enforce single featured news article — unfeature others on toggle/create/update ([b5853ec](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b5853ec3b6769655f8d19914e51fd078ec9edccc))
* expose cabinet_email/password vars in subscription delivered template admin UI ([f82a713](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f82a713110c90494e41f2de9910f5dc60a06962e))
* gift subscription code-only purchase + activation via deep link ([5ffce17](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5ffce175dcb8aebf22cf536bfa032c66da284600))
* implement calculate_renewal_price with tariff and classic modes ([02e5401](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/02e5401327786c9dfe5ae7d4c89624c9455aa53e))
* implement gateway payment for gifts, persist recipient warning ([cd04f3b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cd04f3b622444f45e2edf4a92da581f3d1f79b67))
* include cabinet credentials in subscription delivered email ([fedcf25](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fedcf2569a153ac40699dd5b402208ac86db0fc3))
* include manual admin top-ups in sales statistics revenue ([b80eeea](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b80eeea089568c60c20b1ae165b8dbe887bbe378))
* multi-select scope for referral network graph API ([6a4ce3d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6a4ce3dd38dc3cf2e9db08322093bfd0b84f1e1c))
* prevent self-activation of gift codes ([b30c73c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b30c73c300019646ea4a0d7e1bf758464ee58f0f))
* referral links now point to web cabinet instead of bot ([12ae871](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/12ae871653399bc4ccd23b6394878e814ce9cd75))
* show both bot and cabinet referral links everywhere ([67da390](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/67da3903715e97c0d84d0018efdd74b085ee8720))
* show Platega payment methods inline on main screen ([#2720](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/issues/2720)) ([334db53](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/334db53868ae2f9206fdde97fa575e953a83cbcf))
* добавлен SeverPay в админ-панель и настройки кабинета ([06a00e3](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/06a00e367c303b5426008f38a20393ec4f2e07cd))
* добавлена интеграция SeverPay для пополнения баланса ([abaf279](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/abaf279533d31994a8a70346627c962b43000c64))
* добавлена поддержка RioPay в кабинете ([3d1fbc7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3d1fbc70f8add81d4a3561d63dcd46f385bcc6f1))
* добавлена поддержка RioPay для лендингов и подарков ([04f4e6b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/04f4e6bf6e9031ef8512a07ab36355111c524319))
* поиск платежей в админ-панели с фильтрами и статистикой ([1804c28](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1804c28f0551fbe52883fc36fc4cfcd60d2d6bd6))
* раздельные топики для админских уведомлений ([e15b18f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e15b18fb41b180e7dd3d65f2f058667be321fe85))


### Bug Fixes

* 3 bugs — notification type, referral with channel sub, BOT_USERNAME ([3c96c2a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3c96c2affd5a803311e3c0c9a0f844d2217f387a))
* 3 critical issues from second-round review ([a90d2d9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/a90d2d936793daaadf116cf314b736a9ebfb7c3b))
* accept stale Telegram initData to prevent MiniApp auth failures ([4c2cb63](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4c2cb63cf9f71fb392c3723a99e88ca3d02b127d))
* add abs() to all remaining subscription payment sum queries ([1eb4e18](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1eb4e18c1776b2265a48e0b923a0ca4ee057d912))
* add activate hint to gift pending activation email link ([fa21549](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fa21549cac9098f49e2e32868acce461acd1b40d))
* add back button to payment amount validation errors ([20eff61](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/20eff6170fb752051022a14fa9d927d59ff1d602))
* add diagnostic payload logging in create_user error path ([4990ddf](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4990ddf9e46495b65fc3638ea8d6bed0cbe6b857))
* add explicit File(...) to UploadFile param to fix 422 on media upload ([89bfdc8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/89bfdc8ed6bfba48cfcb61083240d5e6e870f49b))
* add Literal type to SavedMedia and close orphaned PIL Image objects ([ce554cb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ce554cb2a8e606b6060dbf63463e64087a3a7539))
* add Message-ID and Date headers to outgoing emails ([de541ea](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/de541ea1c3fa20c606c0ea1b69a0223569afb9e2))
* add method query param to return_url and latest-payment endpoint ([32d58b0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/32d58b04b9a37473f43ae07cc32d4e18b161e3b9))
* add minimum 8-char length check for gift token in bot deep link ([8a8337f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8a8337f538c3fcaf84b84c34b7a1e38a4ce9d580))
* add missing settings import in admin_users tariff switch ([b2ee6c7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b2ee6c766a1fb0c9a701684a6349b970d12f5e2e))
* add missing total_subscription_revenue_kopeks in scoped graph early return ([bcc761f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/bcc761f9d3f673bd2b404adf817762058d8e0df4))
* add NaloGO fiscal receipt creation for landing page purchases ([4244962](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/424496233773b4cee4e389a1172e95208b3afeaf))
* add nested selectinload and referrer eager loading to prevent MissingGreenlet ([3306e02](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3306e029021c396e13774a205225beece4fbbcfb))
* add null check for subscription in execute_change_devices ([5081deb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5081debee7625954bd7b82f66e09dd58e08e8822))
* add or [] guard to remaining connected_squads call site in fulfill_purchase ([d9f9f3d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d9f9f3dca126963967782160766bd5b26bde7a49))
* add per-category discounts and months multiplier to classic mode ([1660b24](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1660b24f9844374bbd156f9202a8e1550a6beb49))
* add period_days whitelist validation and type annotations ([18e2e78](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/18e2e7841a6d614263e7c87db5964916ec869a9d))
* add post_update=True to User.referrals self-referential relationship ([9957259](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/995725988150f31d193631120a4692e88fa4dd57))
* add selectinload to user lock queries to prevent MissingGreenlet ([5442f28](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5442f288d4c6c3973dd92ac141172a9f0e53a28f))
* add sync_squads=True to admin tariff change handler ([3f0b24c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3f0b24c1ec82ebfb6fdbc801ed6b493ea09c9a2f))
* add table existence guards to migrations for optional payment tables ([f4a7763](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f4a776319eaccbce108a1f22462da6cd592fe0f3))
* add Telegram Stars payment support for gift subscriptions ([5424d8c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5424d8c31484873b0adc0bc980abdc51ee81325b))
* add user ID to payment descriptions for all providers and fix tuple bug ([2f19c76](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2f19c76357fe7de1636d65968cb13f784ee47c31))
* add X-CSRF-Token and X-Telegram-Init-Data to CORS allow_headers ([77456ef](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/77456efb7504e12c9b9879a352118ce1687132b1))
* address 6-agent review findings for PricingEngine ([c9f2dff](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c9f2dffabf6369df360c5f9ad7a12c0415026310))
* address review findings for guest purchase admin notifications ([770f19e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/770f19e84688e55ed44f7c9de26b0e9ae9636c4b))
* address review findings for guest purchase recovery ([57c5c67](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/57c5c679eef987e9bacee1a9d420ac3c0ff69ff7))
* address review findings for multi-provider recovery ([79c110f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/79c110ff41659ff225164c13690bafc859212d05))
* address review findings from 5-agent audit ([08bea70](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/08bea704ded78102dce29deac8da95c4e4b9d815))
* address review findings from 6-agent audit ([5c34656](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5c3465647639d6f07432bc3d725bba9396af6c45))
* admin tariff server selection - 64-byte overflow and callback routing conflicts ([536525c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/536525c9c0a7701321bc3b83d6cef125c6f343ba))
* align context_vars and SAMPLE_CONTEXTS with actual runtime context keys ([ab5313a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ab5313a381f8175346b470d6d1df54d8d7d11ff8))
* align subscription_renewed/activated context_vars with runtime keys ([c507634](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c507634398d3e934246b2c66183ebad1b9949769))
* align tariff pricing with calculate_renewal_price reference ([6349b2f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6349b2f4426abd49e3bd63364f3d2b204a486282))
* allow repeated auto-assignment of promo groups on each purchase ([4a002b7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4a002b7db1bfa8fd1149b0e3dfa469e8912a0e3b))
* atomicity refactor, review fixes, and DELETED recovery logging ([ba54819](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ba54819f9cd7f60914dd472b68885683f435db4e))
* auto-purchase classic extend missing device_limit and traffic_limit_gb ([7dc5e4a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7dc5e4ab94a415dc739a49c74cde511aad0cbb29))
* campaign registration, revenue calculation, backup restore, autopay errors, referral links ([7648707](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7648707ca26d6cd2703b50b0fe8c4697e6155784))
* catch DecompressionBombError, hoist MP4 brands to module level ([172924d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/172924df0e1248b27d3f18f6acf23cf115040941))
* change None assignment to [] + add "or []" guards at all 5 call sites. ([a5fbd74](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/a5fbd7400f828824c5baa520bdaf06023b4caf70))
* code-only gifts skip fulfillment in gateway webhook + retry service ([05bcac5](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/05bcac502efb1b4298a1c6be91bba5d7c057b9f0))
* comprehensive html.escape() for all user/admin data in Telegram HTML messages ([9de3490](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/9de34900a2a9047ab275c0bbf16fd314eb49a3ec))
* comprehensive security hardening across payment and API layers ([8175bc8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8175bc8bfe56dc564a0783c45226451b695bdbd6))
* conditional log messages and sanitize panel_error in user deletion ([289cbe9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/289cbe966e42afe74c8d1b936139941ff84e008b))
* consider subscription status field in network graph ([454dc93](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/454dc9321bb9405c5ff0ff559ae4ced15533f3af))
* correct CryptoBot webhook signature verification and auto-fill topup amount from cart ([d7ad9d7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d7ad9d70330b6ef5599f7a9409cdd16657d61b85))
* correct device_limit and connected_squads in guest purchase fulfillment ([44d46fe](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/44d46feb0adec9255fbf167e9937ea70b711e289))
* correct revenue calculations in referral network ([c8f4cca](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c8f4cca34053713eb2793bbb82e74cbb9a6f893c))
* correct RioPay API header case and remove undocumented fields ([1a87d43](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1a87d438fe127a0b62bd6ee59887212869a3cb17))
* correct skipped_count in sync-squads circuit breaker and simplify ternary ([8a362db](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8a362db7833b5b7793b5b52345d227cb84cbc39e))
* correctly price unlimited traffic (0 GB) in classic subscription mode ([aec04f0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/aec04f0085bd9c566bd033b8bb628389ff22bdf6))
* create uploads subdirectories in Dockerfile for correct permissions ([5ed3780](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5ed3780f830023f7b1940dc96256fd38e3c86f4b))
* daily subscription pause not persisting in cabinet and miniapp ([d3c9940](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d3c994083e3b054d02d4911172968c914724d051))
* deep link auth security and reliability fixes ([099391e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/099391eb5f24319703f12ae2cb72d93b26164d99))
* default payment_method to BALANCE for bot subscription payments ([226d3f2](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/226d3f2766bb0842e5a4aefb1458a9e40389108e))
* derive income_today from revenue_chart to ensure consistency ([1882909](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1882909b3e60f4959921ae085e909bc91c0756b3))
* disable quick amount buttons in balance topup ([d0eab3f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d0eab3f7aacf0249ca244f168c96044347c918e3))
* downgrade known-harmless RemnaWave 400s to warning level ([0419781](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/04197817fede058dc4688dce2f9877f0fc2a7f7f))
* drop legacy prize_days column from contest_templates ([5214f55](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5214f55f46391c7870a38ea51c2efc2f4e518f58))
* encode payment status in provider return URLs and wire failed_url ([275f249](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/275f249bbdf28d065e1b856e4d8ec7e73af4e1aa))
* enforce HTTPS for webapp mode, deduplicate keyboard builder, fix long line ([69dbd6a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/69dbd6a2df4cf5e0dd7156ca0f3beb53c4a061af))
* enforce promo group authorization on country/server selection ([641da94](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/641da949a907ade7b870e1a5385fdb71f9e524af))
* enforce tariff device_price and max_device_limit across all purchase paths ([f9f07f3](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f9f07f360c36ce1eade8a27fa0fa5bf22808db93))
* fix Platega and CryptoBot webhook verification ([b40a812](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b40a812f3aa0596bf6c5105008451dd8a17b103f))
* gift purchase notification and activation flow ([330d1cb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/330d1cb6fe2eee81a3e8f841de75d41e8b4cde40))
* guard rollback on commit flag, add flush to promo_offer_log ([b7775b7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b7775b72dc7a1b3d18f179c2f247fe9f47023347))
* handle duplicate admin roles in RBAC bootstrap ([877b1cd](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/877b1cde11c462c0cf5692119ca09944476a2fb6))
* handle expired subscription in guest purchase fulfillment ([9e78509](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/9e785092843cf7f6b3ebb5bfa1710030c74ceafb))
* handle legacy telegram_id in YooKassa webhook recovery metadata ([815a1d9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/815a1d9136f39b932d4b369aec9d67034d6785d9))
* handle None autopay_days_before in autopayment processing ([f1d4534](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f1d45343e941594d69f71e822ecc9b3a7062f4bf))
* handle spurious user.deleted webhooks — preserve active subscriptions and prevent orphaned panel users ([9eab802](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/9eab80200006e576967204b52f90bf9866875917))
* harden gift subscription feature after multi-agent review ([6a4140e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6a4140e3e203beb20cc56aa9c65dfed70f0a12d7))
* harden remnawave API error handling and YooKassa user cross-validation ([585baaf](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/585baaf63c9f535e5311a32085d0187d8c854001))
* harden YooKassa webhook recovery user lookup ([d35ee58](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d35ee58aa6f3edc6a9e8ab43025569262acf64a2))
* implement case-insensitive email checks in authentication and user retrieval ([7e466ef](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7e466ef464ce918d885bd6297d1e605a633fd43e))
* implement case-insensitive email checks in authentication and user retrieval ([ebee834](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ebee8348ca338b9be5f044537e5e2b4740dc6441))
* improve referral network query correctness and cleanup ([ac9fcd8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ac9fcd8d30dd64fdc7363e689e9ffaf03700976e))
* include landing page revenue in dashboard statistics ([c6c1599](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c6c1599e14a8c7033dfa399ff3f2c3ee6d156598))
* include SUBSCRIPTION_PAYMENT in dashboard revenue ([5f71eaa](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5f71eaa92604faa2c6928994bd32a9c6c8ae7ae5))
* include SUBSCRIPTION_PAYMENT in dashboard revenue calculations ([13dba5a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/13dba5a303604f8d39e85d1382a4d36225f957ac))
* include SUBSCRIPTION_PAYMENT in dashboard revenue calculations ([d7f91c8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d7f91c83584384ef5d0fc90a28debc722b2db79f))
* include SUBSCRIPTION_PAYMENT in recent payments today/week totals ([6982d27](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6982d27378d0dbe5c7b37d1491e6c9d0461dffc8))
* include SUBSCRIPTION_PAYMENT in sales summary and deposits stats ([27ef752](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/27ef75214e73211a68d541f5375ca14275ea86e9))
* increase landing purchase rate limit from 5 to 30 req/min ([801921f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/801921ff74107daccc17e49a0335c7b133268280))
* invalid ISO date format in node usage stats API call ([69a38da](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/69a38dad259bd05f4658e1014ce0bd73fc2e2ac5))
* keep DB session alive in Tribute payment notification handler ([4186159](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4186159a61a40003454afc9c0faf848582cfb037))
* latest-payment endpoint returns all payments, not just pending ([7a9264b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7a9264b1731cf8935c9e3985f41a1df919dfbf83))
* loyalty tiers current status based on spending, not assigned group ([b815abf](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b815abf2b11e32eb658f9a8a63ae902bc0db46f4))
* make migration 0042 idempotent for retry_count column ([5faf701](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5faf7015ac043f44366fd2a5e00be19eab76b945))
* manual admin top-ups missing from sales statistics ([ab43e74](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ab43e74ab7484f8d3517f91e366ea395e1944b99))
* media upload security hardening from 6-agent review ([165d25e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/165d25ef5fc02eecf7c6d703072b6adbe88bfd98))
* merge phantom users into active accounts on /start ([77f1a76](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/77f1a764d59d68236899ec59c884907d3666d3dd))
* migrate pricing to days-based proration, fix promo revenue leaks, fix admin panel bugs ([fcdeff1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fcdeff1ee5155c88c634e12a703159c221d66af5))
* MissingGreenlet crash after subscription purchase in cabinet ([a80a85c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/a80a85c2a489f397efb4ffb5bd77655420a49adb))
* MissingGreenlet crash after subscription purchase in cabinet ([1cc687a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1cc687ac15ecdf12928e5ce448514c09b6628f65))
* MissingGreenlet при изменении количества устройств на CLASSIC подписках ([826accb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/826accba519f23a687fcc3d387f727fd31d2a88c))
* multiple payment and notification bugs ([f4eeb9a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f4eeb9a503d6da8a152f8cb60b89f7ebbdf41c4a))
* narrow exception handling and fix session leak in gift.py ([3875335](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3875335cd7083115043d22f8726f0d33a225cd10))
* negate GIFT_PAYMENT amounts and remove dead code ([f80b058](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f80b0583804f27c322a4eb27f0613163ca1f97e9))
* news module security hardening, perf optimizations, bug fixes ([2b91808](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2b91808b0c72381cfb2f4e36eaff69e9102a32ee))
* normalize threshold 0→NULL in create_promo_group for consistency ([b9089e6](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b9089e693f823e3b8618d08329ccba559592dfa3))
* panel sync now updates end_date in both directions ([def594b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/def594bbb55ef45d3df81524bd8841de73a07340))
* pass cabinet return_url to payment providers for top-up redirects ([7ca9619](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7ca96195a7240ce0c3bd613c20344d79e5219c74))
* pass full token to svc_activate instead of truncated prefix ([38c6adf](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/38c6adfdb4d4fc786bf6ca34a5d54025126130c0))
* payment gateway issues — YooKassa polling, PAL24 card 500 ([95a32e8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/95a32e8574320eeba9276e44551a2f1207ae1e8b))
* payment providers — lock_user_for_update + commit=False atomicity ([b4ef52c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b4ef52caa4b324eded8e6c6cb715a09ad59140c1))
* **payment:** prioritize saved cart after topup over expired auto-extend ([28321df](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/28321df4d274269536efebcf3da870f2e7d07d90))
* phantom user merge on claim failure, referral assignment, account merge hardening ([fad77f8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fad77f8c80a8fdecb0512f0ff91e5ae6d78ec8f3))
* platega webhook ID fallback for SBP and card payments ([aa3459b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/aa3459b8463ce0a54b7709aa3547b2337064fa26))
* preserve purchased devices when admin changes user tariff ([bf72f24](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/bf72f241d81e4432f50a61ec3bb829d18c92955d))
* prevent account takeover via auto_login_token, ensure promo group on all purchase paths ([b3f3eba](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b3f3eba5756404df9ed0f12d8048244ca536f7d3))
* prevent balance loss on auto-purchase for DISABLED subscriptions and fix WATA expiration ([266340a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/266340aad195995f208ed82fc11e0909d34898f4))
* prevent bootstrap from reactivating revoked superadmin roles ([9dd6b54](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/9dd6b54c6e963d2a842d4ac48c9a463014306ed7))
* prevent double balance credit on concurrent Platega webhooks ([0e1296e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0e1296e0ea291ee661aa82508d5eb8049ce23cac))
* prevent double-payment TOCTOU race in all payment providers ([82c79c1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/82c79c130601736cd149350f761dcceacfb7c2db))
* prevent duplicate promo groups during auto-assignment after purchase ([da7a9cc](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/da7a9cc3c5fd771b932a2bfd154400f6f923a4d1))
* prevent guest purchases from getting stuck in PENDING/FAILED status ([2781236](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2781236011942e794949544b9c5422aa8679e5eb))
* prevent MESSAGE_TOO_LONG in promo groups list ([c307278](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c30727823169159b4b6b61f54897b209ced8dfd2))
* prevent premature commits in promocode promo group operations ([8b26680](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8b2668087b4831c08474846b20591b2158d607fc))
* pricing audit — display/charge parity, race conditions, balance locks ([ae99358](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ae99358ae9f35a25370ab127d98a0b630a08e3f2))
* propagate exceptions from get_primary_user_promo_group ([3ec9e71](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3ec9e71de7d8d40e969f9ea738455445d04d983a))
* propagate tariff squad changes to existing subscriptions and fix user deletion from Remnawave ([7ccfb66](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7ccfb66690c93df0c9c694935b16a280ca8ae812))
* protect external squads from deletion during server sync ([b563796](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b563796091e83edcc8dfbd6222648b5346f39a9c))
* quick topup buttons include device/server/traffic costs, broadcast button crash on media messages ([5ebe107](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5ebe1072c9c8a1dcb6ee4cbbea2dc55211b534c4))
* reactivate subscription after traffic top-up when status is EXPIRED ([8b35428](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8b354280558a5f28d1b99eae55ccd21a4af6a07b))
* read discount overrides from landing model instead of response DTO ([6d65e15](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6d65e152669a7e92f93f592993c1d5507b890046))
* record transactions for free tariff switches and admin tariff changes ([864a4ed](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/864a4ed7005195ff3be3a8bb2e7666bc5a7f3e4e))
* referral system — self-referral protection, race condition fix, deleted user re-registration ([ed5a92a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ed5a92ab966dac54c15217050eae87f4b05eed62))
* refresh CLASSIC_PERIOD_PRICES when admin changes PRICE_*_DAYS or SALES_MODE ([6adf70b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6adf70b2da6e2250cc8e909dbb497b355302e72f))
* refresh user subscription after gift activation in /start ([363ccce](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/363ccce56d3e61554ca49d725322a79b05bc65d3))
* register categories/tags/media routers before news to avoid route conflict ([d9cda3a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d9cda3a6d67c6249397e3778c1aefc6bdb6d9e4f))
* reject HEIC as MP4, close UploadFile, narrow exception handling ([7ff73e8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/7ff73e8492343be5ed77fad5eea7e730621eac76))
* remaining context_vars/SAMPLE_CONTEXTS mismatches found by agents ([d72ea6b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d72ea6b7f999c320038f0327a0c541d1cd276244))
* remove begin_nested that breaks activate_purchase transaction ([0005d59](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0005d59da1e58c38561c8346db89d8475a25d7df))
* remove contains_eager conflicting with selectinload on user relationship ([fddf8ef](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fddf8ef5ebc8e5176a75a10e92d59165bdabf2e1))
* remove executable bit from email_service.py ([372d628](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/372d628908294d905c37828219cac6aef7941151))
* remove forced white background from custom email template overrides ([cb61014](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cb61014d9c5a89e3aeafb191f1b9826ca1cbf338))
* remove future annotations breaking UploadFile, harden media URL generation ([0225fa1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0225fa155b7d4f3d1c6572a68651c206b1820db0))
* remove is_active_paid_subscription guard from admin deactivation ([1f664a9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1f664a9083d81bc4462c30bf0626a44b5a30f03e))
* renewal cost estimate double-counts servers and traffic in tariff mode ([bfbefeb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/bfbefeb1e20a191f604bbcbc79b14d8c6e4cd5bd))
* replace asyncio.gather with sequential queries on shared session ([3e69efe](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3e69efe5891bbe8869a7feb2320185e14d83dd73))
* reset device limit to new tariff base on tariff switch ([aec01ce](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/aec01ce0d4a36da5ddd07b56ca4bd5de04735a0b))
* reset QR photo when returning to referral ([3ee108f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3ee108fce85962dde5bc6c80b3464278369da9f5))
* reset subscription for paid users, trial-to-paid tariff conversion, gift purchase MissingGreenlet ([e67b8e4](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e67b8e448e5396ee6daa8c6278bb5a0b313dda74))
* resolve alembic migration failures on fresh database install ([bbd353f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/bbd353ff38af57aa9a8f15c60bded3259a3e3e26))
* resolve concurrent AsyncSession bug and sanitize error responses ([4a5cacd](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4a5cacda386e7fa60ad7b6393aa3372384bee128))
* resolve EmailService stale SMTP config causing NoneType crash on from_email ([2a72dea](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2a72deadd6ac3baea15a8d4ee414d763c16690b0))
* resolve merge conflict with dev (accept calc_device_limit_on_tariff_switch) ([ba049ca](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ba049ca017e004c25f8738f01b2d5f329a35bb5e))
* resolve MissingGreenlet in switch_tariff endpoint ([4d695be](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4d695be7d51adda40fa72c00c349fb0e1ec4acd2))
* resolve NameError in YooKassa successful payment processing ([9d5329d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/9d5329d9d1051eeaf77cfea4932557cdfbf21cc6))
* resolve remaining TOCTOU issues in RioPay, SeverPay and restore paid_at ([afefcc9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/afefcc9c07a80ecf65871bc2d0fbcfe13ffc24fd))
* respect per-channel disable_on_leave settings in monitoring service ([958ec48](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/958ec489a2a1d01d19cb6e60f52fb2be56295104))
* respect send_before_menu flag for pinned messages during new user registration ([20727b1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/20727b1017457769feccccf83e99523c19026a7e))
* respect X-Forwarded-Proto in media URL generation to prevent mixed content ([fd41009](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fd410096ea7e541d8443ec4336bfd72de63d03d9))
* restore connected_squads and admin notification on daily subscription resume ([89341ba](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/89341baa6243496d3b24c501e227ed156676c052))
* retry Remnawave API calls without externalSquadUuid on A039 FK violation ([de00612](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/de006129657ce3dac2b1f2fc0ab1b91e23e44241))
* review findings — db.commit, isinstance guard, constants, ACTIVE check ([72b5305](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/72b5305b870ae9ecdb2672549b9c153dd8b3f7bc))
* sanitize email dots in RemnaWave username generation ([6c20858](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6c208581d936f5ab7d6b978baafd50881b8ce9f1))
* sanitize proxy credentials in all nalogo error paths ([3bf3105](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3bf31055e71ff64e6a6d94486bb7f7775ac7dc91))
* send DISABLED instead of EXPIRED status to RemnaWave API ([79cfcbc](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/79cfcbcece3938f2daa83206f96ec1bffd0857e0))
* silence PARTICIPANT_ID_INVALID error in channel subscription check ([14dceaa](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/14dceaa39ff9faa1c9205483653014a1c5ac73fb))
* simplify 0046 migration downgrade to just drop_table ([015c2da](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/015c2da297e4250ebfa50e32b3c1468c9a2143f3))
* skip non-JSON payload rows in cryptobot payment index and query ([ba79d03](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ba79d03e389afed972296fe2bc05104aa6b883f3))
* stars rate rounding + device/traffic purchase stats ([641ff86](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/641ff86bf6f1ac1f22146f4344beda05759869fc))
* strip newlines from subject substitution, fix subscription notification context ([c9ea2b1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c9ea2b15e9d670d6e1888c0396a145713ec749c0))
* sub-method enabled check, guest payment provider, silent FSM return ([603b9a1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/603b9a1f4610a5b288d6fba78c98474c439529aa))
* **subscription:** remove stale extend promo state fields causing NameError ([20a6fa1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/20a6fa1bcf362455623f43838f4ffaaf98b33e76))
* substitute context variables in email template overrides ([d52c87b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d52c87b2b752d3f432096318ac2ec4f9ad792929))
* substitute sample context in admin test email for template overrides ([351d714](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/351d714f2d4c200e8ab4263ff006ae33ec062d95))
* superadmin role managed exclusively via env config ([e0bedc8](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e0bedc8e780a2f91509517110639773e90bb6125))
* support {total_amount} placeholder in cart notification templates ([f4ab174](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f4ab174d32be8b48470320c27c92e75fdabd6d58))
* support prefix-based gift code lookup for activation ([4fb72ae](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4fb72ae6e3bc65d93ab84b594b4ff5b4856c5357))
* support Telegram OIDC id_token in account linking endpoint ([680c22c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/680c22c0179253d24f7f89e115a283dac92f9a49))
* suppress harmless TelegramBadRequest errors and fix discount promo display ([0fe3c21](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0fe3c217f752ced2e3c3f56b4ab5b4c898ba2d8e))
* swap Caddy auth headers — api_key to Authorization, caddy_token to X-Api-Key ([038c34e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/038c34e52a863d0c5c6993ea785587ba7e0bc61d))
* sync crypto link from happ.cryptoLink in webhook handlers ([0ceff44](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0ceff44c30cf11466c4cbe51b520558c51c4af4a))
* sync squads to Remnawave panel on tariff purchase/switch ([c34fdd1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c34fdd10a0a22a85a4e29cbf44da2ac5d4a643b3))
* treat expired and limited subscription statuses as inactive in referral network graph ([5ed2f0c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5ed2f0c95842a43ab57220dc05ca346748bd6adb))
* undefined currency variable in RioPay payment creation ([5b33534](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5b3353433bc524e3e51f2ae87d26bd162bd9f97b))
* update promo group via M2M table so admin changes persist ([68bc8eb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/68bc8eb57c792059d2be8a8fff6bba3254d3773d))
* use --frozen instead of --locked in Dockerfile to avoid version mismatch ([923b36a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/923b36a8b9caed5db1c147a5ef4c001f66f8170a))
* use 'kassa_ai' base model name for guest metadata patch ([182667e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/182667ecb86f9bbbe87d640865dcbcaadf9e72f6))
* use abs() for subscription payment amounts in referral network ([056c13b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/056c13bc23e6737f44bbcb802a66b643349f75a9))
* use base model name for KassaAI guest metadata patch ([b6d4373](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b6d43739337cd2e2cfd61ac33398eb6def5b28b6))
* use get_rendered_override for proper variable substitution in guest email overrides ([c165cca](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c165cca3239c9a1249aae9e5e712f7e34fb01107))
* use IF EXISTS in downgrade for FK indexes ([76b1f9b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/76b1f9b036e276646546aa4c89a3fe1d2ee58a40))
* use information_schema for constraint existence checks in migrations ([fc65e2d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fc65e2de4c9c08e7df1886c458b53f7a05894934))
* use keyword args for Path.mkdir in asyncio.to_thread ([2879996](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/287999645506a49b6693a184757598e1cdceb4d8))
* use parsed HTML length for Telegram caption limit checks ([2649e12](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2649e12f64b8f825a3db85b95da6a335b0f8eec6))
* use pg_class lookup for constraint existence checks in migrations ([ba335fe](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ba335fe78430e26b9e2449dbbd6db209557698e0))
* user deletion FK error + connected_squads None TypeError ([a5fbd74](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/a5fbd7400f828824c5baa520bdaf06023b4caf70))
* validate FK existence, add FK indexes, expand video brand whitelist ([f0cdd5d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f0cdd5dc904926b55be390798a71a5427a20949b))
* validate period_days against tariff in purchase-tariff and auto-purchase ([4660ca5](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4660ca5756f5f1ef8033f9202d68612d570ddb1a))
* добавлен импорт MAX_ALL_TIME_DAYS в admin_payments routes ([ad26832](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ad268329be45bdd665ce4a6f142e9762a78e55b5))
* добавлены RioPay и SeverPay в REAL_PAYMENT_METHODS ([f967c29](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f967c29bd7cfe8a66e7e0f492573bb7521fcda22))
* защита внешних сквадов от удаления при синхронизации серверов ([f84885c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f84885cc8aa0c9a70f916076e987284f1f9c3479))
* исправлен расчёт конверсии в статистике продаж ([3089c17](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3089c1704b54323b4c2a151d40a5b395a427c658))
* исправлены проблемы RioPay интеграции после ревью ([4abb8cb](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4abb8cb1a3f21089697199261bcc37e6f6a5c623))
* лог полного payload при ошибке PATCH /api/users для диагностики A039 ([8d7f0ee](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8d7f0eea0fecd9e66bf199bd2c288e073f1354c0))
* миграция Tribute webhook с deprecated user_id на trb_user_id ([9419941](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/94199413c283167edd829b337cf9bec0a5414a54))
* не пересылать activeInternalSquads в рутинных обновлениях RemnaWave (A039) ([4aaf0dd](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4aaf0ddd25527ec23fa6a479ac3826d6b6266761))
* не пересылать externalSquadUuid в рутинных обновлениях RemnaWave ([3d68db0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3d68db0a51fac55640d44be784c832875ca2da17))
* расширен лог PATCH /api/users payload для диагностики A039 ([db2f0c9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/db2f0c93f2974410e744411fb9111c6de1f0f0be))
* режим «Контакт и тикеты» возвращает support_type='both' вместо 'tickets' ([2f33e55](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/2f33e5514469f2686c4b35e2105f4188a41d4145))
* реферальный бонус инвайтера — сумма вместо максимума, защита флага первого пополнения ([e1bcb1b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e1bcb1ba910ef3a79dec5fa974ae8e6c09494aa7))
* скрыть плашку верификации email при выключенной верификации ([4966e39](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/4966e39eb9b92967ef92c92ae434ca6cdea80c84))
* сохранение user_id до rollback чтобы избежать MissingGreenlet при lazy load ([3f8e899](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3f8e8993b2949b5a5e04b1d8a468ef7dc1170e08))
* убрана отправка externalSquadUuid=null в RemnaWave API и исправлен ложный лог синхронизации рулетки ([f80912e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/f80912e444ab5706c809e689ca5ed2a38da118d0))
* уведомление об истечении подписки теперь учитывает autopay_enabled пользователя ([c0b282a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c0b282a189a2b761c68fc70886edd91d9c807ff6))
* устранена отправка externalSquadUuid=null в RemnaWave API (A039) и исправлен reduce_devices ([e453521](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e4535210982351413cb82483000fe441e7b7300a))


### Performance

* add covering indexes for referral network queries ([b5471b7](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b5471b7720213c217fc452dc1234a7d3c53447d5))


### Refactoring

* add typed breakdowns + module-level singleton to PricingEngine ([b551def](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b551def3402e2bf762406fb0b374360958231bb3))
* centralize Bot instantiation via create_bot() factory ([0a53b85](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/0a53b85b8a3193f67e148c0f2bde246cc92f010c))
* deduplicate gift activation in start.py ([769d3a0](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/769d3a0b309fb6be1c3175cd66a0df7cb6e2fb67))
* deduplicate KassaAI handlers with config dict and shared helpers ([e4bb043](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e4bb0430fb9cc4f55013767ceda6d1c214bd80a6))
* extract _compute_subscription_status shared helper ([8b8f1b9](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8b8f1b91f37f829528f785a40e3a9cb98c85e043))
* extract phantom service, replace lightweight merge with execute_merge ([6658af6](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/6658af6268c10db170e3eaabc75f857e5c664c3c))
* extract shared formatting helpers into app/utils/formatting.py ([5e9a462](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/5e9a462261e46ee649de481266a821fd6793bf2e))
* make finalize() accept both old and new pricing types ([3efa24b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/3efa24bab3a2bd1d31103b134e502c10af8e41e1))
* migrate admin user price calculation to PricingEngine ([49c0f3f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/49c0f3fc10d27092961601cf7f6a780fb56885fa))
* migrate all callers to pricing_engine singleton + fix miniapp discount ([e24b911](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e24b911283bf4cbee7b18d3e49c935217e4a2863))
* migrate bot renewal display to PricingEngine ([ce82c2c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/ce82c2c00988542ac73dc9d2e811711ea9cefebe))
* migrate bot renewal execute to PricingEngine ([acf27a1](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/acf27a102308d38676b2ccaef78016b56a80935d))
* migrate cabinet renewal display + execute to PricingEngine ([28fc36d](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/28fc36dca41b626430baf823274561269023ac59))
* migrate cart auto-purchase to PricingEngine (fresh calc) ([bd2e93a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/bd2e93a6a5076341b104f7dba2b7fc5fdb587e66))
* migrate menu.py renewal pricing to PricingEngine ([652b6da](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/652b6dabde014d19075f13198dd06e5fb8bef380))
* migrate miniapp renewal display + execute to PricingEngine ([cb43aca](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cb43acab3194bbf9b6e2c04ca0254ba5b2571b2d))
* migrate recurrent and monitoring services to PricingEngine ([978f68e](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/978f68e7be42b0faf92d9ac5bc0bbaa2022ac95b))
* migrate remaining callers to PricingEngine + cleanup dead CRUD ([75dbd2b](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/75dbd2b4fcc8ab14ac44d915bf55b10406544bb1))
* migrate try_auto_extend_expired to PricingEngine ([e6ebc67](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e6ebc6722d826d291156e6bff3bf86000b32b783))
* move KASSA_AI_SUB_METHODS to service layer, add early enabled checks ([cda2392](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cda239241122ae1dd02a252b3eadc47453c0c48b))
* move squad propagation to service layer with parallel Remnawave sync ([79161ea](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/79161eaae4d67c82c45b6ea3654c0b15c8b785a4))
* remove dead pricing code and fix miniapp classic mode ([c9a9816](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c9a9816daa15a4534a3990822543eeefe1a1631b))
* remove estimated price from balance, simplify server sync, fix HTML injection ([a798f11](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/a798f1143eebf52e18254bddd610f7f14a0c4056))
* remove quick amount buttons feature entirely ([136f29c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/136f29c1eb63778b2b329ed5bf72ab06a4531d0b))
* rename GIFTCODE_ start parameter prefix to GIFT_ ([42b6c80](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/42b6c80a48ad0100d5ddbbe99a096ebb7b292f08))
* simplify referral invite text to single template ([cbe630c](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/cbe630cab0973d7d71dd72603b114807b237ac84))
* unify first-purchase discount algorithm with PricingEngine ([fe4e6ac](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/fe4e6acb5391d0797ea01281eeb2e2ea59a0070f))
* централизация всех расчётов цен в PricingEngine ([8d3cd50](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8d3cd500980f4f640cb1ba493150f1f20e8bd58c))


### Documentation

* add bot preview screenshot to README ([d7931a2](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/d7931a2afaf272aae74453f2bb6d493593895f67))
* add cabinet preview screenshot to README ([b032c8f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/b032c8f35435ddd592df04d6352097580f5e9837))
* add icons and list all 14+1 payment providers ([1306c24](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/1306c24fa36fd3e812c5bec551a0aca450ca7d2c))
* add Redis to tech stack ([c14d7ab](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/c14d7ab0af2e5dd4f35213b323a97eedcc99af0e))
* add Redis to tech stack ([e12cc9f](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/e12cc9f248764104d538db1daaede9ddd8b77b2d))
* add WATA partnership block to payments section ([31bdf8a](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/31bdf8a0aeba53fcec40358d0a38b8480130a346))
* increase logo size to 800px ([22e7f15](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/22e7f150b30c35b0419e7923e94c5ebc92c4b61a))
* redesign README — concise feature showcase, link to docs ([38deb70](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/38deb70f8118d371e36ac92a4417bdb543635fc9))
* replace header logo with new artwork ([6888822](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/688882237fe3019bb78d5e1d7ad54faf4cd69c09))
* WATA partnership block with logo and table card ([8d5a002](https://github.com/Legacyyy777/remnawave-bedolaga-telegram-bot/commit/8d5a0029964ba52b40e03ebfe8ab6f4146d3aca9))
